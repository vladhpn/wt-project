          ...
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                type="text"
                id="first_name"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-2xl fony-bold rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
